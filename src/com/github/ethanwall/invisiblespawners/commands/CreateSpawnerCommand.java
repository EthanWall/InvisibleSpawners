...
public class CreateSpawnerCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		switch (args.length) {
		case 9:
			return execute(sender, args[0], args[1], args[5], args[6], args[7], args[8], args[2], args[3], args[4]);
		case 8:
	...
	private boolean execute(CommandSender sender, String name, String mobType, String x, String y, String z, String world, String range, String numberOfSpawns, String interval) {
		...
		return execute(sender, name, convMobType, convLocation, convRange, convNumberOfSpawns, convInterval);
	}
	...
	private boolean execute(CommandSender sender, String name, String mobType, String range, String numberOfSpawns, String interval) {
		...
		return execute(sender, name, convMobType, player.getLocation(), convRange, convNumberOfSpawns, convInterval);
	}
