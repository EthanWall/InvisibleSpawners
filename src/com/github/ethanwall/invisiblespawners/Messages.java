...
public final class Messages {
	...
	public static final String EFFECT_NOT_FOUND_MESSAGE = ChatColor.DARK_RED + "That potion effect could not be found!";
	...
	public static final String EFFECT_REMOVED_MESSAGE = ChatColor.GREEN + "The effect " + ChatColor.BLUE + "%s" + ChatColor.GREEN + " has been successfully removed!";
